...
namespace AutoSharp
{
    ...
    public abstract class PluginBase
    {
        ...
        {
            get { return Player.ManaPercent > ConfigValue<Slider>("HarassMana").Value; }
        }
        ...
        public virtual void OnPossibleToInterrupt(Obj_AI_Hero unit, Interrupter2.InterruptableTargetEventArgs spell) { }
